...
public class StringStartsWith extends SubstringMatcher {
     ...
     */
    public static Matcher<String> startsWith(String prefix) { return new org.hamcrest.core.StringStartsWith(false, prefix); }
     ...
     *      the substring that the returned matcher will expect at the start of any examined string
     */
    public static Matcher<String> startsWithIgnoringCase(String prefix) { return new org.hamcrest.core.StringStartsWith(true, prefix); }
