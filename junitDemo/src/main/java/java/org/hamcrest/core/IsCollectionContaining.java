...
public class IsCollectionContaining<T> extends TypeSafeDiagnosingMatcher<Iterable<? super T>> {
    ...
    public static <T> Matcher<Iterable<? super T>> hasItem(Matcher<? super T> itemMatcher) {
        return new org.hamcrest.core.IsCollectionContaining<>(itemMatcher);
    }
    ...
    public static <T> Matcher<Iterable<? super T>> hasItem(T item) {
        ...
        return new org.hamcrest.core.IsCollectionContaining<>(equalTo(item));
    }
    ...
    public static <T> Matcher<Iterable<T>> hasItems(Matcher<? super T>... itemMatchers) {
        ...
        for (Matcher<? super T> elementMatcher : itemMatchers) {
          // Doesn't forward to hasItem() method so compiler can sort out generics.
          all.add(new org.hamcrest.core.IsCollectionContaining<>(elementMatcher));
        }
